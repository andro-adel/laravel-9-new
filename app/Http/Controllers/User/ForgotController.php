...
class ForgotController extends Controller
{
    ...
    public function forgot(Request $request)
    {
      ...
      $admin->update($input);
      $this->sendForgetPasswordEmail($autopass,$request->email);
...
//      }
    ...
    public function sendForgetPasswordEmail($password,$email) {
        try {
            Mail::to($email)->send(new ForgetPasswordMail($password));
