                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-page-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="title_ar" placeholder="{{ __('title arabic') }}" required="" value="{{ Request::old('title') }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea  class="nic-edit-p" name="details" placeholder="{{ __('Description Ar') }}">{{ Request::old('details') }}</textarea> 
                              <div class="checkbox-wrapper">
                                <input type="checkbox" name="secheck" class="checkclick" id="allowProductSEO">
                                <label for="allowProductSEO">{{ __('Allow Page SEO') }}</label>
                              </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="submit" class="addProductSubmit-btn" type="submit" value="{{ __('Create Page') }}">
                          </div>
                        </div>
                      </form>
                      </div>
