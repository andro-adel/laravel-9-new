                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-page-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="title_ar" placeholder="{{ __('title arabic') }}" value="{{$data->title_ar}}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea class="nic-edit-p" name="details_ar" placeholder="{{ __('Description Ar') }}">{{ $data->details_ar }}</textarea> 
                                <div class="checkbox-wrapper">
                                  <input type="checkbox" name="secheck" class="checkclick" id="allowProductSEO" {{ ($data->meta_tag != null || strip_tags($data->meta_description) != null) ? 'checked':'' }}>
                                  <label for="allowProductSEO">{{ __('Allow Page SEO') }}</label>
                                </div>
