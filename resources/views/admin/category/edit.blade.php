                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        {{--Arbic Feild row Start--}}

                          <div class="row">
                              <div class="col-lg-4">
                                  <div class="left-area">
                                      <h4 class="heading">Name In Arabic |الاسـم باللغة العربيه *</h4>
                                  </div>
                              </div>
                              <div class="col-lg-7">
                                  <input type="text" class="input-field" name="name_ar"  required="" value="@isset($data_ar->name_ar){{$data_ar->name_ar}} @endisset">
                              </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <input type="number" class="input-field" name="commission" placeholder="{{ __('Set Commission') }}" required="" value="{{$data->commission}}">
                              </div>
                          </div>
