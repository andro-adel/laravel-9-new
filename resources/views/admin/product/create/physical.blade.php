							...
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="col-lg-12">
										<div class="left-area">
											<h4 class="heading"> {{ __('Product Name') }}* </h4>
											<p class="sub-heading">{{__('(Product Name In Arabic)')}}</p>
										</div>
									</div>
									<div class="col-lg-12">
										<input type="text" class="input-field" placeholder="{{ __("Enter Product Name") }}"
										...
										<div class="col-lg-12">
											<select id="cat" name="category_id" required="">
												...
												<option data-href="{{ route('admin-subcat-load',$cat->id) }}"
													value="{{ $cat->id }}">{{$cat->name_ar}}</option>
												@endforeach
											</select>
										</div>
									</div>
									...
									<div class="showbox">
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<input type="text" class="input-field ship_req " placeholder="{{ __('Estimated Shipping Time') }}" id="ship_req"  name="ship">
											</div>
										</div>
									</div>
														...
														<div class="row">
															...
															<div class="col-md-4 col-sm-6">
																...
																<input type="number" name="size_qty[]" class="input-field"
																	placeholder="{{ __('Size Qty') }}" value="1" min="1" required>
															</div>
															<div class="col-md-4 col-sm-6">
																<label>
																	{{ __('Size Price') }} :
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="left-area">
											<h4 class="heading">
											    {{ __('Product Description In Arabic') }}
									...
									<div class="col-lg-12">
										<div class="text-edit">
											<textarea name="details_ar" class="nic-edit-p"></textarea>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="row">
										<div class="col-lg-12 text-center">
											<button  type="submit">{{ __('Create Product') }}</button>
										</div>
									</div>
							</div>
						</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
												<div class="panel panel-body">
												    <h6>{{__('image size 1600 * 1600')}}</h6>
													<div id="image-preview" class="img-preview" style="width: 100%; height: 285px; border: 1px dashed #ddd; background-repeat: no-repeat; background: url({{ asset('assets/admin/images/upload.png') }});">
                                                        <label for="image-upload" class="img-label p-2 text-center" id="image-label"style="     position: absolute;
    display: block;
    margin: 0 auto;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%); cursor:pointer; color:#ffffff; background:#2d3274; border-radius: 50px; "><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                                        <input type="file" name="photo" class="img-upload" id="image-upload" style="display:none">
                                                      </div>
