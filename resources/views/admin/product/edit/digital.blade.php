						...
						<div class="product-description">
							<div class="body-area">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="left-area">
											<h4 class="heading">أسم المنتج | Product Name * </h4>
											<p class="sub-heading">أسم المنتج بالعربيه | Product Name In Arbic</p>
										</div>
									</div>
									<div class="col-lg-12">
										<input type="text" class="input-field" placeholder="{{ __("Enter Product Name") }}"
											   name="name_ar" required="" value="@isset($data_ar->name_ar){{ $data_ar->name_ar }}@endisset">
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="left-area">
											<h4 class="heading">
												Product Description In Arabic |تفاصيل المنتج بالعربي *
											</h4>
										</div>
									</div>
									<div class="col-lg-12">
										<div class="text-edit">
											<textarea class="nic-edit-p" name="detail_ar">@isset($data_ar->details_ar){{$data_ar->details_ar}}@endisset</textarea>
										</div>
									</div>
								</div>
