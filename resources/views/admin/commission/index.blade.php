...
@section('content')  
	...
	<div class="content-area">
		<div class="mr-breadcrumb">
			<div class="row">
				<div class="col-lg-12">
						<h4 class="heading">{{ __("commissions") }}</h4>
						<ul class="links">
							<li>
								<a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }} </a>
							</li>
							<li>
								<a href="{{ route('admin.commission.index') }}">{{ __("commission all") }}</a>
							</li>
						</ul>
				</div>
			</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-commission-datatable','none') }}',
               columns: [
...
<div class="modal fade"
	 id="confirm-delete1"
	 tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
