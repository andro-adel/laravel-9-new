            ...
            <div class="body-area">
              ...
              <form id="geniusformdata" action="{{route('admin-service-create')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                      ...
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="title_ar" placeholder="{{ __('title arabic') }}" required="" value="">
                      </div>
                    </div>
                ...
                <div class="row">
                      ...
                      <div class="col-lg-7">
                        <textarea  class="input-field" name="details_ar" placeholder="{{ __('Description Ar') }}"></textarea>
                      </div>
                    </div>
