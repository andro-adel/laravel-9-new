      ...
      <div class="col-lg-12">
        <ul class="pages">
          @php
            ...
            $price = $product->showPrice($productt->price);
            $name = $product->showName($productt->name);
            $details = $productt->details;
            if(isset($productt->name_ar)){
                $name = $productt->name_ar;
            }
            if(isset($productt->details_ar)){
                $details = $productt->details_ar;
            }
            $previous_price = $product->showPreviousPrice($productt->previous_price);
          @endphp
          <h4>{{$name}}</h4>
          ...
          @endif
          <li><a href="{{ route('front.product', $productt->slug) }}">{{ $name }}</a>
  ...
  <div class="container">
          ...
          <div class="xzoom-container">
            ...
            <div class="product-price">
              <p class="title">{{ $langg->lang87 }} :</p>
                    <p class="price"><span id="sizeprice">{{ $price }}</span>
                      <small><del>{{ $previous_price }}</del></small></p>
                    ...
                    <ul class="siz-list">
                      ...
                      <li class="{{ $is_first ? 'active' : '' }}">
                        <span class="box">{{ $data1 }}
                          ...
                          @php 
                              $data_qty = isset($productt->size_qty[$key]) ? $productt->size_qty[$key] : $productt->size_qty[0];
                              $data_price = isset($productt->size_price[$key]) ? $productt->size_price[$key] : $productt->size_price[0];
                          @endphp
                          <input type="hidden" class="size_qty" value="{{ $data_qty }}">
    ...
    @endif
      ...
      <div class="categori  mt-30">
        <div class="section-top" style="background:#4E53E1">
