							  ...
							  <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>			
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __("Enter Product Name") }}"
												   name="name_ar" required="" value="@isset($data_ar->name_ar){{ $data_ar->name_ar }}">
										</div>
									</div>
								...
								<div class="{{ $data->measure == null ? 'showbox' : '' }}">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<div class="text-edit">
												<textarea class="nic-edit-p" name="details_ar">@isset($data_ar->details_ar){{$data_ar->details_ar}}@endisset</textarea>
											</div>
										</div>
									</div>
