									...
									<div class="col-lg-4 col-md-4 col-6 remove-padding">
										...
										<a href="{{ route('front.product', $prod->slug) }}" class="item">
										    @if($prod->is_official == 1)
    											<center>
    											     <span calss=" offi bg-info text-white" style="float:right!important;padding-bottom:5px!important;font-size: 13px;z-index :1; background-color:#d81e26;color:#fff;padding-left:5px;padding-right:5px;" >
