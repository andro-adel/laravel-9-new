									...
									<div class="col-lg-4 col-md-4 col-6 remove-padding">
										...
										<a href="{{ route('front.product', $prod->slug) }}" class="item">
											...
											<center>
											     ...
											     style="float:right!important;padding-bottom:5px!important;font-size: 13px;z-index :1; background-color:#d81e26;color:#fff;padding-left:5px;padding-right:5px;" >
                                                        {{$langg->official_store}}
											     </span>
											</center>
											@endif
											<div class="item-img" style="z-index :-1;">
												...
												@endif
													...
													<div>
											            ...
											            <img class="img-fluid"  style="z-index :-1;" src="{{ $prod->thumbnail ? asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt="">
											        </div>
											</div>
											<div class="info">
												<div class="stars">
