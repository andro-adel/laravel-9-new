    ...
    <li>
        <a href="#fines" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-hand-holding-usd"></i>{{ __('Fines') }}</a>
        <ul class="collapse list-unstyled" id="fines" data-parent="#accordion" >
            <li>
                <a href="{{route('admin.fines')}}"> {{ __('Fines') }}</a>
            </li>
            <li>
                <a href="{{route('admin.fines.create')}}"> {{ __('add fine') }}</a>
            </li>
            
        </ul>
    </li>
    <li>
        <a href="#commission" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-hand-holding-usd"></i>{{ __('commissions') }}</a>
        <ul class="collapse list-unstyled" id="commission" data-parent="#accordion" >
            <li>
                <a href="{{route('admin.commission.index')}}"> {{ __('commissions') }}</a>
            </li>
            <li>
                <a href="{{route('admin.commission.pending')}}"> {{ __('commission pending') }}</a>
            </li>
            <li>
                <a href="{{route('admin.commission.processing')}}"> {{ __('commission processing') }}</a>
            </li>
            <li>
                <a href="{{route('admin.commission.completed')}}"> {{ __('commission completed') }}</a>
            </li>
        </ul>
    </li>
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-prod-approve-index') }}"><span>{{ __('product need to approve') }}</span></a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="vendor" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-vendor-accept-index') }}"><span>{{ __('pending requests') }}</span></a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-gs-commsionm') }}"><span>{{ __('commission value') }}</span></a>
            </li>
            <li>
