...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/', 'Admin\FinesController@index')->name('admin.fines');
  Route::get('/create', 'Admin\FinesController@create')->name('admin.fines.create');
  Route::get('/imposed/{id}','Admin\FinesController@imposed')->name('admin.fine.imposed');
  Route::post('/store/{id}', 'Admin\FinesController@store')->name('admin.fines.store');
  Route::get('/edit', 'Admin\FinesController@edit')->name('admin.fine.edit');
  Route::post('/update', 'Admin\FinesController@update')->name('admin.fine.update');
  Route::get('/destroy/{id}', 'Admin\FinesController@destroy')->name('admin.fine.destroy');
});
  Route::get('/finesdatatable', 'Admin\FinesController@datatables')->name('admin.finesdatatable');
  Route::get('vendor/fines/datatable', 'Admin\FinesController@datatables_vendor')->name('admin.vendor.finesdatatable');
  //------------ ADMIN Commissions SECTION ------------
    ...
    Route::group(['prefix'=>'commission'],function(){
        ...
        Route::get('/get/all','Admin\CommissionController@index')->name('admin.commission.index');
        Route::get('/get/pending','Admin\CommissionController@all_pending')->name('admin.commission.pending');
        Route::get('/get/processing','Admin\CommissionController@all_processing')->name('admin.commission.processing');
        Route::get('/get/completed','Admin\CommissionController@all_completed')->name('admin.commission.completed');
        Route::get('/datatables/{slug}', 'Admin\CommissionController@datatables')->name('admin-commission-datatable');

    });

    //************************ Commission End **************************//

    //------------ ADMIN Commissions SECTION ENDS ------------
  
  //------------ ADMIN Fines SECTION ENDS ------------
  ...
  Route::get('/products/pending', 'Admin\ProductController@pending')->name('admin-prod-approve-index');
  Route::get('/products/pending/{id}', 'Admin\ProductController@approve')->name('admin-prod-approve');
  ...
  Route::get('/vendors/pending', 'Admin\VendorController@accept_admin')->name('admin-vendor-accept-index');
  Route::get('/vendors/request/accept/{id}', 'Admin\VendorController@accept_request')->name('admin-vendor-request-accept');
  ...
  Route::get('/vendors/accept/{id}', 'Admin\VendorController@accept_request')->name('admin-vendor-accept');
  Route::get('/vendors/datatables/accept', 'Admin\VendorController@datatables_accept')->name('admin-vendor-datatables_accept');
...
// Verification Section Ends
 ...
 //------------ ADMIN PRODUCT DISCUSSION SECTION ENDS ------------
  ...
  Route::get('/general-settings/commissionvalue', 'Admin\GeneralSettingController@commission_val')->name('admin-gs-commsionm');
...
Route::prefix('vendor')->group(function() {
  ...
  Route::get('/dashboard', 'Vendor\VendorController@index')->name('vendor-dashboard');
    ...
    Route::post('/contract/{id}','Vendor\VendorController@contract')->name('admin-vendor-contract');
    //IMPORT SECTION
...
// ************************************ FRONT SECTION **********************************************
  ...
  //SeeAll
  Route::get('seeall/{section_name}','Front\FrontendController@seeall')->name('front.seeall');
  //SeeAll End
  ...
  Route::post('/APS','Front\ApsGateWay@store')->name('APS');
  Route::get('/APS/done','Front\ApsGateWay@apsreturn')->name('apsreturn'); 
...
Route::get('/order/cancel/{order}','User\OrderController@cancel')->name('user.order.cancel');
Route::get('/item/cancel/{order}/{id}','User\OrderController@cancel_item')->name('user.cancel.item');