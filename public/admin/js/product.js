                                ...
                                '<span class="remove size-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            ...
                                            '</label>'+
                                            '<input type="text" name="size[]" class="input-field" placeholder="Size Name" required>'+
                                        '</div>'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Size Qty :'+
                                            ...
                                            '</label>'+
                                            '<input type="number" name="size_qty[]" class="input-field" placeholder="Size Qty" required value="1" min="1">'+
                                        '</div>'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Size Price :'+
                                            ...
                                            '</label>'+
                                            '<input type="number" name="size_price[]" class="input-field" placeholder="Size Price" required value="0" min="0">'+
                                        '</div>'+
                                    '</div>'+
                                '</div>'
                            +'');
